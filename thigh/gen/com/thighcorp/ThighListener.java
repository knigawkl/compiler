...
public interface ThighListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ThighParser#assignment_operation}.
	 * @param ctx the parse tree
	 */
	void enterAssignment_operation(ThighParser.Assignment_operationContext ctx);
	/**
	 * Exit a parse tree produced by {@link ThighParser#assignment_operation}.
	 * @param ctx the parse tree
	 */
	void exitAssignment_operation(ThighParser.Assignment_operationContext ctx);
	/**
